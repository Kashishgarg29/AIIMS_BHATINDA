...
const CATEGORIES: { id: string; title: string; fields: FieldDefinition[] }[] = [
  ...
  },
  {
    ...
    fields: [
      { id: "scratchesHead", label: "Child constantly scratches the head", isDefault: true },
      { id: "rubsEyes", label: "Child rubs eyes" },
      { id: "headache", label: "Child complains of frequent headache", isDefault: true },
      { id: "cannotSeeBoard", label: "Child cannot see what is written on the board", isDefault: true },
      ...
      { id: "faintingEpisodes", label: "Episodes of fainting esp. in summers", isDefault: true },
